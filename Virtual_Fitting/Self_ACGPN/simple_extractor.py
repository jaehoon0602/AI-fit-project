...
from Self_ACGPN import networks
from Self_ACGPN.utils.transforms import transform_logits
from Self_ACGPN.datasets.simple_extractor_dataset import SimpleFolderDataset
...
def get_arguments():
    ...
    parser.add_argument("--model-restore", type=str, default='lip_final.pth', help="restore pretrained model parameters.")
    parser.add_argument("--gpu", type=str, default='0', help="choose gpu device.")
    parser.add_argument("--input-dir", type=str, default='./Data_preprocessing/test_img', help="path of input image folder.")
    parser.add_argument("--output-dir", type=str, default='./Data_preprocessing/test_label', help="path of output image folder.")
